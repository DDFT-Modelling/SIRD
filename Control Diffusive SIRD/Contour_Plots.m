...
% Second contour plot in [0.3,0.6] x [0,1]

msize = 40;
F = zeros(msize,msize);
C = linspace(0.3,0.6,msize);
W = linspace(0.4,0.7,msize);
...
h.EdgeColor = [142,140,169]/255;
xlabel('$\beta$','Interpreter','latex','fontsize',11,'color','#555555')
ylabel('$\gamma$','Interpreter','latex','fontsize',11,'color','#555555')
set(gca,'XColor','#555555')
set(gca,'YColor','#555555')
colormap(viridis)
...
exportgraphics(figure(3), 'Diffusive_Contours_Finer.pdf', 'BackgroundColor','none','ContentType','vector')
