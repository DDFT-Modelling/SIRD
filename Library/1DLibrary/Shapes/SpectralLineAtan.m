classdef SpectralLineAtan < Spectral
    ...
    methods
        function this = SpectralLineAtan(Geometry)
...
%             [y,dy,dx,ddx,dddx,ddddx] = AtanMap(x,this.alpha1,this.alpha2);
%        end
       
       function y = PhysSpace(this,x)
            y = InvAtanMap(x,this.alpha1,this.alpha2);
       end
       
       
        function xf = CompSpace(this,y)
            xf  = InvAtanMap(y,this.alpha1,this.alpha2);
        end                    
