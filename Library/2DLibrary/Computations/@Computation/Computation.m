classdef Computation < handle
    ...
    methods (Access = public)   
        ...
        function Preprocess(this)                                                 
            ...
            PreprocessIDC(this);
            if(isfield(this.optsNum,'SubArea'))
        ...
        function configName = SaveConfig(this,configuration)    
            ...
            if(isfield(configuration.optsNum,'configDir'))
                configDir = configuration.optsNum.configDir;
            else
            ...
            if(isfield(configuration.optsNum,'configSubDir'))
                configDirFull = [configDirFull filesep configuration.optsNum.configSubDir];
                configuration = rmfield(configuration.optsNum,'configSubDir');
            end
            ...
            index         = LoadIndexFiles(configDirFull);
            resave        = true;
